# Main runner of Charms
# Contains listener functions that execute code when entering/exiting a grammar rule
# Defines varTable, functionDirectory and generates quadruples
...
def main(argv):
	...
	lexer = CharmsLexer(FileStream(argv[1])) # Read input file as a command-line argument
